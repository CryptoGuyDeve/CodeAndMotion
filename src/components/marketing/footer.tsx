                ...
                <Container>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <p className="text-muted-foreground mt-4 text-sm text-start">
                            Cutting-edge platform that streamlines your web development, video editing, and graphic design workflows in no time.
                        </p>
                    </div>
                </Container>
                        ...
                        <Container delay={0.4} className="h-auto">
                            <div className="mt-10 md:mt-0 flex flex-col">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground space-y-4">
                                    <li className="mt-2">
                                        <Link href="/contactus" className="link hover:text-foreground transition-all duration-300">
                                            Contact US
                                        </Link>
                                    </li>
                                </ul>
                                <ul className="mt-4 text-sm text-muted-foreground space-y-4">
                                    <li className="mt-2">
                                        <Link href="/portfolio" className="link hover:text-foreground transition-all duration-300">
                                            Portfolio
                                        </Link>
                                    </li>
                                </ul>
            ...
            <Container delay={0.5} className="w-full relative mt-12 lg:mt-20">
                <div className="mt-8 md:flex md:items-center justify-center footer w-full">
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; {new Date().getFullYear()} Code&Motion. All rights reserved.
                    </p>
                </div>
            </Container>
        </footer>
