            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Effortless Video Editing <br /> with <span className="font-subheading italic">Fast Delivery</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Effortless video editing with fast delivery. Streamline your editing process, enhance your content quickly, and get polished videos ready to share in no time.
                    </p>
                </div>
            </Container>
